// SINCRONIZAÇÃO PERFEITA - REPLICA EXATA DO FRONTEND
// Usa APENAS classes Tailwind + CSS compilado (sem estilos forçados)
...
// Extrair CSS compilado EXATO do build
function getExactCompiledCSS() {
  try {
...
export function generatePerfectSyncHTML(data) {
  const compiledCSS = getExactCompiledCSS();
  
  console.log('🎯 Gerando HTML com sincronização PERFEITA...');
...
<head>
    ...
    <style>
        ...
        /* APENAS GARANTIAS MÍNIMAS - SEM SOBRESCREVER TAILWIND */
        * {
        ...
        /* CONTAINER PRINCIPAL - APENAS DIMENSÕES */
        #curriculo-preview {
            width: 210mm;
            height: 297mm;
            font-size: 11px;
...
<body>
    <!-- REPLICA EXATA DO CurriculumPreview.tsx - SEM MODIFICAÇÕES -->
    <div 
      ...
      <div class="flex h-full">
        ...
        <div class="w-1/3 bg-gradient-to-br from-slate-800 via-teal-800 to-cyan-800 text-white p-6 relative overflow-hidden">
          ...
          <div class="text-center mb-6">
            <!-- Avatar - ESTRUTURA EXATA DO FRONTEND -->
            <div class="w-24 h-24 bg-gradient-to-br from-yellow-400/30 to-white/10 rounded-full mx-auto mb-3 flex items-center justify-center backdrop-blur-sm border-2 border-white/40 relative overflow-hidden">
              <!-- Padrão geométrico - EXATO DO FRONTEND -->
        ...
        <!-- Conteúdo Principal - EXATO DO FRONTEND -->
