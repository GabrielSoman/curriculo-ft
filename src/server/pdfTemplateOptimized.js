// Template HTML OTIMIZADO que replica EXATAMENTE o design do frontend
// SEM Tailwind, SEM dependências externas, APENAS CSS puro

export function generatePureCSSHTML(data) {
  return `
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Container principal - EXATAMENTE como o frontend */
        .curriculum-container {
            width: 794px;  /* 210mm em pixels */
            height: 1123px; /* 297mm em pixels */
            margin: 0;
            background: white;
            display: flex;
            position: relative;
        ...
        /* Sidebar - REPLICA EXATA do frontend */
        .sidebar {
        ...
        /* Avatar - REPLICA EXATA do padrão geométrico */
        .profile-avatar {
            width: 96px;
            height: 96px;
...
<body>
    ...
    <!-- Scripts CDN para geração de PDF -->
