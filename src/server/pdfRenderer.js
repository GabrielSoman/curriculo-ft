...
export async function renderPDFViaFrontend(data) {
  ...
  try {
    ...
    if (fs.existsSync(assetsPath)) {
      ...
      console.log('✅ Arquivos encontrados em assets:', { cssFile, jsFile });
    } else {
      console.log('⚠️ Pasta assets não encontrada, usando CSS inline');
    }
    // Gerar HTML com CSS puro inline (independente de arquivos externos)
    console.log('✅ HTML unificado gerado com CSS puro inline');
    return htmlContent;
    
  } catch (error) {
    console.error('❌ Erro ao gerar HTML unificado:', error);
    throw error;
  }
}
